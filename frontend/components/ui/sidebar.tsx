  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="inline-block whitespace-pre text-sm text-neutral-700 !m-0 !p-0 transition duration-150 group-hover/sidebar:translate-x-1 dark:text-neutral-200"
      >
        {link.label}
      </motion.span>
    </Link>
